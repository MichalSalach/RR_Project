...
link <- bookmakers_df %>% filter(bookmakers==pull(data_max_return[paste0('player_',data_max_return$better_non_favourite[1], '_bookmaker')])[1]) %>% select(bookmakers_links)
...
# Option 1
Book `r book` adress: `r link`

# Option 2
[`r book`](`r link`)

# Option 3
[`r pull(data_max_return[paste0('player_', data_max_return$better_non_favourite[1], '_bookmaker')])[1]`](`r bookmakers_df %>% filter(bookmakers==pull(data_max_return[paste0('player_',data_max_return$better_non_favourite[1], '_bookmaker')])[1]) %>% select(bookmakers_links)`)
